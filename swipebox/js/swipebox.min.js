/*! Swipebox v1.4.4 MODD | Constantin Saguin csag.co | MIT License | github.com/brutaldesign/swipebox */
...
(function($, window, document) { $(function() {
    $("a[rel~='lightbox']:not(.ext-pdf)").swipebox();
    $("a.gdbbx-bbcode-attachment").swipebox();
